document.getElementById('header__children-movies').addEventListener('click', function () {
  ...
  body.style.backgroundImage = 'url("static/assets/images/backgrounds/balloons.png")'
})
...
document.getElementById('header__menu').addEventListener('click', function () {
  ...
  body.style.backgroundImage = 'url("static/assets/images/backgrounds/background_main.webp")'
})
